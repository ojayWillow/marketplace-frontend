...
const HowItWorksSection = () => {
  ...
  return (
    <div className="mt-3 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl shadow-sm dark:shadow-gray-900/50 overflow-hidden">
      <button
      ...
      >
        ...
        <svg
          className={`w-4 h-4 text-gray-400 dark:text-gray-500 transition-transform md:hidden ${howItWorksOpen ? 'rotate-180' : ''}`}
      ...
      <div className={`px-4 pb-4 md:px-6 md:pb-5 ${howItWorksOpen ? 'block' : 'hidden md:block'}`}>
        <ul className="text-gray-600 dark:text-gray-400 space-y-1.5 text-sm md:text-base">
