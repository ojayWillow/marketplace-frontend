  ...
  return (
    <div className="grid grid-cols-2 gap-3 my-5 p-3.5 bg-gray-50 dark:bg-gray-800 rounded-xl">
      <div className="text-center p-2">
        ...
        <div className="text-xs text-gray-500 dark:text-gray-400 font-medium">Budget</div>
      ...
      <div className="text-center p-2">
        ...
        <div className="font-bold text-sm text-gray-900 dark:text-gray-100 truncate">{task.location?.split(',')[0] || 'N/A'}</div>
      </div>
      <div className="text-center p-2">
        <div className="text-xl mb-1">⚡</div>
        <div className="text-xs text-gray-500 dark:text-gray-400 font-medium">Difficulty</div>
      ...
      <div className="text-center p-2">
        <div className="text-xl mb-1">📅</div>
        <div className="text-xs text-gray-500 dark:text-gray-400 font-medium">Posted</div>
