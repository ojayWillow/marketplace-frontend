    ...
    <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 mb-6">
        ...
        <div className="md:hidden flex items-center justify-between -mt-2 -mx-2 mb-2">
          {onOpenSettings ? (
            <button
              ...
              aria-label={t('settings.language.title', 'Settings')}
            >
      ...
      <div className="flex flex-col sm:flex-row gap-6">
        ...
        <div className="relative flex-shrink-0">
          <div className="w-24 h-24 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center overflow-hidden ring-4 ring-gray-50 dark:ring-gray-800">
            {currentAvatarUrl ? (
              <img 
          ...
          {profile.is_verified && (
            <div className="absolute -bottom-1 -right-1 bg-blue-500 text-white rounded-full p-1 shadow border-2 border-white dark:border-gray-900">
          ...
          {!viewOnly && editing && (
            <button
              ...
              className="absolute -bottom-1 left-1/2 -translate-x-1/2 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 px-2 py-0.5 rounded-full text-xs hover:bg-gray-700 dark:hover:bg-gray-300 transition-colors"
            >
        ...
        <div className="flex-1 min-w-0">
          ...
          {(profile.first_name || profile.last_name) && (
            <p className="text-gray-600 dark:text-gray-400">{profile.first_name} {profile.last_name}</p>
          )}
          ...
          <div className="flex items-center gap-4 mt-3">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-gray-500 dark:text-gray-400 text-sm">{t('profile.tasksDone')}</span>
            </div>
          </div>
      ...
      {!viewOnly && !editing && (
        <div className="hidden md:flex flex-wrap gap-2 mt-5 pt-5 border-t border-gray-100 dark:border-gray-700">
          <Link
            to="/tasks/create"
