      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        <div className="px-4 py-2">
          <button
            ...
            className="w-full flex items-center gap-3 py-3 px-1 rounded-lg text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 active:bg-red-100 dark:active:bg-red-900/30 transition-colors"
          >
            ...
            <svg className="w-4 h-4 text-red-400 dark:text-red-500 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
