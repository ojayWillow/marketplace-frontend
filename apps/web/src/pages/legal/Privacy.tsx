    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          <Link 
            to="/" 
            className="inline-flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 mb-6 text-sm font-medium"
          >
        ...
        {/* Content */}
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm dark:shadow-gray-950/50 border border-gray-100 dark:border-gray-800 p-6 sm:p-10 space-y-8">
          ...
          <section>
            ...
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/40 rounded-lg p-4 mb-4">
          ...
          <section className="border-t border-gray-100 dark:border-gray-800 pt-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <a href={`mailto:${t('legal.privacy.sections.contact.email')}`} className="text-blue-600 dark:text-blue-400 hover:underline">
        ...
        <div className="mt-8 text-center">
          <Link to="/terms" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-sm font-medium">
            {t('legal.terms.title')} →
          </Link>
        </div>
      </div>
