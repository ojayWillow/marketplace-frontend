          ...
          <div className="mb-8">
            ...
            {filteredTasks.length === 0 ? (
              <div className="text-center py-12 bg-white rounded-lg">
                ...
                <p className="text-gray-400">{hasActiveFilters ? t('tasks.tryDifferentFilters', 'Try adjusting your filters') : t('tasks.checkBackLater', 'Check back later')}</p>
              </div>
            ) : (
          ...
          <div>
            ...
            {filteredOfferings.length === 0 ? (
              <div className="text-center py-12 bg-white rounded-lg">
                ...
                <p className="text-gray-400">{hasActiveFilters ? t('tasks.tryDifferentFilters', 'Try adjusting your filters') : t('offerings.checkBackLater', 'Check back later')}</p>
              </div>
            ) : (
