  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 mb-2">
        ...
        {price && (
          <span className={`text-lg font-bold flex-shrink-0 ${item.type === 'job' ? 'text-blue-600' : 'text-amber-600'}`}>
            €{price}
          </span>
        )}
      </div>
          ...
          <div className="flex items-center gap-1 text-[11px]">
            {hasReviews ? (
              <>
                ...
                <span className="text-gray-400 flex-shrink-0">({item.creator_review_count})</span>
              </>
            ) : (
