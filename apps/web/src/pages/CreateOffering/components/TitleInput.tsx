        ...
        <div className="mt-1.5 flex flex-wrap gap-1">
          {suggestions.map(s => (
            <button
              ...
              className="px-2.5 py-1 bg-gray-100 hover:bg-amber-50 hover:text-amber-700 text-gray-600 rounded-full text-[11px] font-medium transition-colors border border-gray-200 hover:border-amber-300"
            >
              {s}
            </button>
          ))}
