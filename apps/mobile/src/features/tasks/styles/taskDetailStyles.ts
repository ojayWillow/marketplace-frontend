...
// Legacy static styles (for backwards compatibility during migration)
export const styles = StyleSheet.create({
  ...
  urgentBadge: { backgroundColor: '#fef3c7', paddingHorizontal: 6, paddingVertical: 3, borderRadius: 12 },
  urgentText: { fontSize: 12 },
  flagIcon: { fontSize: 16, opacity: 0.5 },
  price: { fontSize: 22, fontWeight: '800', color: ACCENT_COLOR },
  heroTitle: { fontSize: 20, fontWeight: '700', color: '#111827', marginBottom: 12, lineHeight: 26 },
  ...
  statsRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f9fafb', borderRadius: 10, padding: 12 },
  ...
  imageCard: { borderRadius: 12, marginBottom: 10, position: 'relative' },
  ...
  sectionCard: { backgroundColor: '#ffffff', borderRadius: 12, padding: 16, marginBottom: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 2 },
...
export const createTaskDetailStyles = (theme: 'light' | 'dark') => {
  const themeColors = colors[theme];
  const accentColor = themeColors.primaryAccent;
  ...
  return StyleSheet.create({
    ...
    urgentText: { fontSize: 12, color: theme === 'dark' ? '#fef3c7' : '#92400e' },
    flagIcon: { fontSize: 16, opacity: 0.5 },
    price: { fontSize: 22, fontWeight: '800', color: accentColor },
    
    heroTitle: { fontSize: 20, fontWeight: '700', color: themeColors.text, marginBottom: 12, lineHeight: 26 },

    userRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
    avatar: { width: 44, height: 44, borderRadius: 22 },
    avatarPlaceholder: { width: 44, height: 44, borderRadius: 22, backgroundColor: accentColor, justifyContent: 'center', alignItems: 'center' },
    avatarText: { color: '#ffffff', fontSize: 18, fontWeight: '700' },
    userInfo: { flex: 1, marginLeft: 10, gap: 2 },
    userName: { fontSize: 15, fontWeight: '600', color: themeColors.text },
    userCity: { fontSize: 12, color: themeColors.textSecondary },
    messageBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: accentColor, justifyContent: 'center', alignItems: 'center' },
    messageBtnText: { fontSize: 18 },
    ...
    sectionTitle: { fontSize: 11, fontWeight: '700', color: themeColors.textMuted, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8 },
    ...
    locationHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
    distanceText: { fontSize: 13, fontWeight: '600', color: accentColor },
    locationAddress: { fontSize: 14, color: themeColors.text, marginBottom: 10 },
    mapBtn: { 
    ...
    mapBtnText: { fontSize: 13, fontWeight: '600', color: accentColor },

    noticeCard: { borderRadius: 10, padding: 12, marginBottom: 10 },
    noticeInfo: { backgroundColor: theme === 'dark' ? 'rgba(56, 189, 248, 0.15)' : '#dbeafe' },
    noticeWarning: { backgroundColor: theme === 'dark' ? 'rgba(245, 158, 11, 0.15)' : '#fef3c7' },
    noticeSuccess: { backgroundColor: theme === 'dark' ? 'rgba(16, 185, 129, 0.15)' : '#dcfce7' },
    noticeText: { fontSize: 13, fontWeight: '500', color: themeColors.text, textAlign: 'center' },
    ...
    btnContent: { paddingVertical: 6 },
    btnLabel: { fontSize: 16, fontWeight: '700' },
    dangerBtn: { borderColor: theme === 'dark' ? '#7f1d1d' : '#fecaca' },
    successBtn: { backgroundColor: '#10b981' },
    ownerActions: { gap: 8 },
    ownerBtnRow: { flexDirection: 'row', gap: 8 },
    halfBtn: { flex: 1, borderRadius: 12 },
    ...
    celebrateIcon: { fontSize: 64, marginBottom: 16 },
    celebrateTitle: { fontSize: 24, fontWeight: '700', color: themeColors.text, marginBottom: 8 },
    celebrateText: { fontSize: 16, color: themeColors.textSecondary, marginBottom: 24 },
    celebrateButtons: { flexDirection: 'row', gap: 12 },
  });
};
