...
export const createHomeStyles = (themeColors: typeof colors.light) => StyleSheet.create({
  // Container
...
export const createJobCardStyles = (themeColors: typeof colors.light) => StyleSheet.create({
  jobCard: {
    flexDirection: 'row',
...
export const createFocusedCardStyles = (themeColors: typeof colors.light) => StyleSheet.create({
  focusedCard: {
...
export const createModalStyles = (themeColors: typeof colors.light) => StyleSheet.create({
  // Modal Base
