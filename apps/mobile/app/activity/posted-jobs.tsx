...
export default function PostedJobsScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['bottom']}>
      <Stack.Screen options={{ title: 'Jobs I Posted', headerBackTitle: 'Profile' }} />
        ...
        <View style={styles.content}>
          {isLoading ? (
            ...
            <View style={styles.centerContainer}>
              ...
              <Text style={styles.emptySubtext}>Post a job to find help</Text>
...
const styles = StyleSheet.create({
  ...
  createButton: { marginTop: 16, backgroundColor: '#0ea5e9' },
  ...
  category: { color: '#0ea5e9', fontSize: 13, marginBottom: 6 },
  description: { color: '#6b7280', marginBottom: 12, lineHeight: 20 },
  cardFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  price: { color: '#0ea5e9', fontWeight: 'bold', fontSize: 16 },
